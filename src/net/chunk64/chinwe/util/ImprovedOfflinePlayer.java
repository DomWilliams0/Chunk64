...
public class ImprovedOfflinePlayer
{
	...
	public Location getLocation()
	{
		...
		return new Location(Bukkit.getWorld(new UUID(this.compound.getLong("WorldUUIDMost"), this.compound.getLong("WorldUUIDLeast"))), ((NBTTagDouble) position.get(0)).data, ((NBTTagDouble) position.get(1)).data, ((NBTTagDouble) position.get(2)).data, ((NBTTagFloat) rotation.get(0)).data, ((NBTTagFloat) rotation.get(1)).data);
	}
